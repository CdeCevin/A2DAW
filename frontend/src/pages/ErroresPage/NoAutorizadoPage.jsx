                    ...
                    <Card.Content>
                        ...
                        <div className='max-w-md lg:max-w-lg flex flex-col justify-center items-center'>
                            ...
                            <div className="flex justify-center items-center">
                                <span className="text-6xl font-bold font-montserrat text-accent-aqua-vg">403</span>
                            </div>
                        </div>
                    <span className="text-gray-500 mt-5"> No tienes permisos para acceder a esta página. Revisa el URL o vuelve a una página conocida.</span>
